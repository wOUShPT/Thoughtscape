Shader "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Terrain/Lit"
{
    Properties
    {
    ...
    Dependency "AddPassShader" = "Hidden/VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Terrain/Lit (Add Pass)"
    Dependency "BaseMapShader" = "Hidden/VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Terrain/Lit (Base Pass)"
    Dependency "BaseMapGenShader" = "Hidden/Universal Render Pipeline/Terrain/Lit (Basemap Gen)"
    
    CustomEditor "UnityEditor.Rendering.Universal.AdvancedDisolve_TerrainLitShaderGUI"
