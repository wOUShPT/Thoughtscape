Shader "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Baked Lit"
{
    Properties
    {
...
float4 dissolaveAlpha = AdvancedDissolveGetAlpha(input.uv0AndFogCoord.xy, input.positionWS.xyz, input.normal.xyz, input.dissolveUV);
DoDissolveClip(dissolaveAlpha); 

float3 dissolveAlbedo = 0;
float3 dissolveEmission = 0;
float dissolveBlend = DoDissolveAlbedoEmission(dissolaveAlpha, dissolveAlbedo, dissolveEmission, input.uv0AndFogCoord.xy, 1);
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.AdvancedDisolve_BakedLitShader"
}
