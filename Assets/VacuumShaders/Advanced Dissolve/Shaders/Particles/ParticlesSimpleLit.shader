...
// No shadow
// No distortion
Shader "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Particles/Simple Lit"
{
    Properties
    {
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.AdvancedDisolve_ParticlesSimpleLitShader"
}
