// ------------------------------------------
// No shadows
Shader "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Particles/Lit"
{
    Properties
    {
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.AdvancedDisolve_ParticlesLitShader"
}
