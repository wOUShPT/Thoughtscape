Shader "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Nature/SpeedTree7"
{
    Properties
    {
    ...
    Dependency "BillboardShader" = "VacuumShaders/Advanced Dissolve/Universal Render Pipeline/Nature/SpeedTree7 Billboard"
